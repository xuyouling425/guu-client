								...
								<form role="form" id="templateForm" action="${base}/template/add" enctype="multipart/form-data" method="post">
									<div class="col-lg-12">
										<div class="form-group">
											<label>模板ID</label> <input class="form-control" type="text" id="templateID" name="templateId" >
										</div>
										<div class="form-group">
												<label>模板显示图片</label>
										...
										<div class="form-group">
											<label>模板名称 </label> <input class="form-control" type="text" id="templateName" name="templateName" >
										</div>
										<div class="form-group">
											<label>模板类型</label> <input class="form-control" type="text" id="type" name="type" >
										</div>
