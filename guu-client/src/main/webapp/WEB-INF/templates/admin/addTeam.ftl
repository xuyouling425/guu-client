				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<form role="form" id="teamForm" action="${base}/team/add" enctype="multipart/form-data" method="post">
									<div class="col-lg-12">
										...
										<div class="form-group">
											<label>成员姓名 </label> <input class="form-control" type="text" id="userName" name="userName" >
										</div>
										<div class="form-group">
											<label>家庭电话</label> <input class="form-control" type="text" id="phone" name="phone" >
										</div>
										<div class="form-group">
											<label>移动电话</label> <input class="form-control" type="text" id="telphone" name="telphone" >
										</div>
										<div class="form-group">
											<label>成员email </label> <input class="form-control" type="email" id="email" name="email" >
										</div>
