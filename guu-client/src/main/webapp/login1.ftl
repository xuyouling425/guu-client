...
<head>
    ...
    <link href="resources/common/font-awesome/css/font-awesome.css" rel="stylesheet">

    <!-- SB Admin CSS - Include with every page -->
    <link href="resources/admin/css/sadmin.css" rel="stylesheet">
...
<body>
    ...
    <script src="resources/common/js/jquery-1.10.2.js"></script>
    <script src="resources/common/js/bootstrap.min.js"></script>
    <script src="resources/common/js/plugins/metisMenu/jquery.metisMenu.js"></script>

    <!-- SB Admin Scripts - Include with every page -->
    <script src="resources/admin/js/sadmin.js"></script>
